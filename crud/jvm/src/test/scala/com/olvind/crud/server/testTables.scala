...
trait testTables {
  ...
  implicit val c0 = Stringifier.instance(Name)(_.value)
  implicit val c1 = Stringifier.instance(Desc)(_.value)
  implicit val c2 = Stringifier.instance(StoreId)(_.value)
  implicit val c3 = Stringifier.instance(ProductId)(_.id)
  implicit val c4 = Stringifier.instance(Price)(_.value)

  implicit val e1 = StringifierRow(Product.tupled,  Product.unapply)
  implicit val e2 = StringifierRow(Store.tupled,    Store.unapply)
